...
export const handlePlaySound = (sound) => { // Lida com tocar o som da tecla...
...
export const handlePlayComposition = (songArray) => { // Lida com tocar do input...
    let wait = 0;

    for (let songItem of songArray) { // Percorre o array...
        setTimeout(() => { // Função de tempo...
            handlePlaySound(`key${songItem}`); // Chama a função para tocar o som...
